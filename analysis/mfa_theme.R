...
cbbPalette <- c("#FB5607", "#8338EC", "#FF006E", "#F2BC0C",  "#3A86FF", '#6EC200', '#BA3200', "#009E73")
...
theme_memcauliffe_light <- function (base_family="Gentium Book Plus") {
  base_size = 12
  half_line <- base_size/2
  theme_bw(base_size=base_size, base_family=base_family) %+replace%
    theme(
      ...
      panel.border = element_rect(color='#001D3D', fill='NA'),
      panel.grid.major = element_line(size = 0.25, linetype = 'solid',
                                      colour = "#001D3D"),
      panel.grid.minor = element_line(size = 0.125, linetype = 'solid',
                                      colour = "#001D3D"),
      axis.text = element_text(size = rel(1.2), colour = "#001D3D"),
      axis.text.y = element_text(margin = margin(r = 0.8*half_line/2),
                                 hjust = 1, colour = "#001D3D"),
      axis.title = element_text(colour = "#001D3D", size = rel(1.6)),
      plot.title = element_text(colour = "#001D3D", size = rel(1.8), hjust=0,
                                margin = margin(b = half_line * 1.2)),
      strip.background = element_rect(fill = "#001D3D", colour = NA),
      strip.text = element_text(colour = "#001D3D", size = rel(1.2),  margin = margin( b = 3, t = 3,  l = 4, r = 4)),
      legend.background = element_blank(),
      legend.key = element_blank(),
      legend.title = element_text(size = rel(1.2), colour = "#001D3D"),
      legend.text = element_text(size = rel(1), colour = "#001D3D"),
    )
}
